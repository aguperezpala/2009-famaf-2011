...
CREATE TABLE "comunidad"(
	...
	"comunidad.direccion.nro" uint,
	"comunidad.direccion.calle" VARCHAR(50),
	"sector.cp" uint NOT NULL,
...
CREATE TABLE "planilla" (
	...
	"vivienda.forma_tenencia" forma_tenencia,
	"vivienda.ocv" boolean DEFAULT False,
	"vivienda.techo" varchar(50),
	"vivienda.tipo" tipo_vivienda,
...
CREATE TABLE "grupo_familiar" (
	...
	"jefe.dedicacion_actual" varchar(50),
	"jefe.trabaja_actualmente" boolean,
	"jefe.forma_de_cobro" forma_cobro,
