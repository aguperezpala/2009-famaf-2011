...
/* Funcion de intensidad del proceso: lambda(t)  */
static double f (double t) { return 3.0+4.0/(t+1.0); }


/* Cota para la funcion de intensidad */
static double lambda = 7.0;
...
int main (int argc, char **argv)
{
	...
	if (argc != 2) {
		fprintf (stderr, "Debe especificar el valor de T para que el "
				"proceso generado sea N(T)\ncon funcion de "
				"intensidad f(x)\n");
		exit (EXIT_FAILURE);
	} else {
